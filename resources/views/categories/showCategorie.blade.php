...
<body class="w-full min-h-screen bg-slate-50 flex flex-col">
    ...
    <main class="w-full flex flex-col gap-8 p-[5%]">
            ...
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                <div class="space-y-4">
                    ...
                    <div class="relative pl-6">
                        <div class="absolute left-0 top-0 bottom-0 w-1 bg-linear-to-b from-[#F59F0A] to-amber-100 rounded-full"></div>
        ...
        <div class="flex flex-col gap-8 bg-white p-8 rounded-4xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7">
            @foreach ($categorie->links as $link)
                <div class="group relative bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] rounded-4xl p-7 hover:shadow-[0_20px_40px_rgba(245,159,10,0.08)] hover:-translate-y-1.5 transition-all duration-300 flex flex-col h-full">
                    <div class="absolute top-5 right-5 flex gap-2 opacity-0 group-hover:opacity-100 -translate-y-2.5 group-hover:translate-y-0 transition-all duration-300 z-10">
            ...
            <button type="button" id="addLien_Modal_button" 
                class="group relative h-full min-h-[280px] border-2 border-dashed border-slate-200 rounded-4xl flex flex-col items-center justify-center p-8 hover:border-[#F59F0A] hover:bg-amber-50/30 transition-all duration-500 cursor-pointer">
